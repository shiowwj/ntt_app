 ...
 */
	const handleLogin = handleSubmit(async (data) => {
		...
		if (loginResult !== null && loginResult?.id) {
			const userDBResult = await UserDBService().getUser(loginResult);

			//  set user context
			// redirect to dashboard page
			if (userDBResult !== undefined && userDBResult.username) {
				useCurrentSearchResultContext.setCurrentUser(userDBResult);
			}
		}
	});
